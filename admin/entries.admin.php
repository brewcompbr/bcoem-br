...
<thead>
 ...
 <tr<?php if (($row_log['brewConfirmed'] == "0") && ($action != "print")) echo " style='background-color: #ff9; border-top: 1px solid #F90; border-bottom: 1px solid #F90;'"; elseif ((check_special_ingredients($entry_style)) && ($row_log['brewInfo'] == "")) echo " style='background-color: #ff9; border-top: 1px solid #F90; border-bottom: 1px solid #F90;'"; ?>>
  ...
  <span class="icon"><a href="<?php echo $base_url; ?>index.php?section=brew&amp;go=<?php echo $go; ?>&amp;filter=<?php echo $row_log['brewBrewerID']; ?>&amp;action=edit&amp;id=<?php echo $row_log['id']; if ($row_log['brewConfirmed'] == 0) echo "&amp;msg=1-".$row_log['brewCategory']."-".$row_log['brewSubCategory']; else echo "&amp;view=".$row_log['brewCategorySort']."-".$row_log['brewSubCategory']; ?>"><img src="<?php echo $base_url; ?>images/pencil.png"  border="0" alt="Edit <?php echo $row_log['brewName']; ?>" title="Edit <?php echo $row_log['brewName']; ?>"></a></span><span class="icon"><a href="javascript:DelWithCon('includes/process.inc.php?section=<?php echo $section; ?>&amp;go=<?php echo $go; ?>&amp;filter=<?php echo $filter; ?>&amp;dbTable=<?php echo $brewing_db_table; ?>&amp;action=delete','id',<?php echo $row_log['id']; ?>,'Are you sure you want to delete the entry called <?php echo $row_log['brewName']; ?>? This cannot be undone.');"><img src="<?php echo $base_url; ?>images/bin_closed.png"  border="0" alt="Delete <?php echo $row_log['brewName']; ?>" title="Delete <?php echo $row_log['brewName']; ?>"></a></span><span class="icon"><a id="modal_window_link" href="<?php echo $base_url; ?>output/entry.php?<?php if ((NHC) && ($prefix == "final_")) echo "go=recipe&amp;"; ?>id=<?php echo $row_log['id']; ?>&amp;bid=<?php echo $row_log['brewBrewerID']; ?>" title="Print the Entry Forms for <?php echo $row_log['brewName']; ?>"><img src="<?php echo $base_url; ?>images/printer.png"  border="0" alt="Print the Recipe Form for <?php echo $row_log['brewName']; ?>" title="Print the Recipe Form for <?php echo $row_log['brewName']; ?>"></a></span><?php if ((NHC) && ($prefix == "final_")) { ?>
